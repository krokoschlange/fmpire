...
public:
	Arc() noexcept;
	Arc(const T& x, const T& y, const float radius, const float start, const float end, const uint segments = 300);
	Arc(const Point<T>& pos, const float radius, const float start, const float end, const uint segments = 300);
